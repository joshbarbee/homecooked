// Generated from c:/Users/thisi/Documents/Programming/homecooked/ExprLexer.g4 by ANTLR 4.13.1
...
public class ExprLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LCURLY", "RCURLY", "LPAREN", "RPAREN", "LBRACKET", "RBRACKET", "SEMI", 
			"UNDERSCORE", "PERIOD", "COMMA", "COLON", "STATEMENT_START", "STATEMENT_END", 
			"FINISH", "FOR", "IF", "ELSE", "OR", "AND", "NOT", "IN", "ASSIGN", "LESS", 
			"GREATER", "EXP", "MUL", "DIV", "ADD", "SUB", "MOD", "NONE", "TRUE", 
			"FALSE", "NUMBER", "INTEGER", "DECIMAL_INTEGER", "OCT_INTEGER", "HEX_INTEGER", 
			"BIN_INTEGER", "FLOAT_NUMBER", "NON_ZERO_DIGIT", "DIGIT", "OCT_DIGIT", 
			"HEX_DIGIT", "BIN_DIGIT", "POINT_FLOAT", "EXPONENT_FLOAT", "INT_PART", 
			"FRACTION", "EXPONENT", "ID", "WS", "SYMBOLS"
		};
	}
